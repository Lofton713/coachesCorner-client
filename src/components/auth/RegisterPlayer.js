...
import { registerPlayer, registerUser } from "../../managers/AuthManager"

export const RegisterPlayer = ({ setToken, setUserId }) => {
        ...
        <section className="columns is-centered">
            <form className="column is-two-thirds" onSubmit={handleRegister}>
                ...
                <div className="field">
                    ...
                    <div className="control">
                        <input className="input" type="date" ref={birthday} />
                    </div>
                </div>
                ...
                <div className="field">
                    ...
                    <div className="control">
                        <input className="input" type="number" ref={GPA} step="0.1" />
                    </div>
                </div>
                ...
                <div className="field">
                    ...
                    <div className="control">
                        <input className="input" type="text" ref={hometown} />
                    </div>
                </div>
                ...
                <div className="field">
                    ...
                    <div className="control">
                        <input className="input" type="text" ref={state} />
                    </div>
                </div>
